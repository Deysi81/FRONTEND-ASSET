...
const VerticalNavHeader = (props: Props) => {
  ...
  const imagePath = '/ruta/a/tu/logo.jpg';
  ...
  return (
    <MenuHeaderWrapper className='nav-header' sx={{ pl: menuHeaderPaddingLeft() }}>
      {userNavMenuBranding ? (
        ...
        <StyledLink href='/'>
          <img src="/images/logos/logo_black.png" alt="Descripción del Logo" width="70"  />
...
// <svg width={50} fill='none' height={50} viewBox='20 0 228 120' xmlns='http://www.w3.org/2000/svg'>
//   <ellipse cx="130" cy="65" rx="90" ry="50" fill="gray" fill-opacity="0.7" />

//     <text x="30" y="120" font-size="200" font-family="Courier New" font-weight="bold" fill="blue">A</text>

//     <text x="130" y="120" font-size="200" font-family="Courier New" font-weight="bold"  fill="blue">F</text>
// </svg>
