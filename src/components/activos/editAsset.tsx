...
import GetImages from './imageEdit'
 ...
 const providerId = props.providerId
  ...
  const getsupplier = async () => {
    ...
    try {
      ...
      setGroupSupplier(response.data.suppliers)
    } catch (error) {
      console.error(error)
    }
  }
    ...
    switch (step) {
      ...
      case 0:
        return (
          ...
          <Fragment>
            <Grid item xs={8} sm={20} lg={30} style={{ display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
            <GetImages id={asset.file}/>
            ...
            <Grid item xs={12} sm={6}>
              ...
              <Typography variant='body2' gutterBottom>
                ...
                >
                 ...
                 <Autocomplete
                    options={groupSupplier}
                    getOptionLabel={option => option.managerName}
                    value={groupSupplier.find(option => option._id === asset.supplier) || null}
