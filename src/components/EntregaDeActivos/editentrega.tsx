...
const SidebarEditEntrega = (props: { providerId: string }) => {
 ...
 //Responsable
//  function handleResponsibleChange(event: SelectChangeEvent<string>, child: ReactNode): void {
//   setAsset({ ...asset, transmitter: event.target.value as string })
...
// function handleReceiverChange(event: SelectChangeEvent<string>, child: ReactNode): void {
//   setAsset({ ...asset, receiver: event.target.value as string })
// }
...
console.log('ocupados',groupAssetOcup)
  ...
  return (
    <>
    {findPermission('ACTIVO_EDITAR_ENTREGA_ACT')?(
      ...
      >
        ...
        <Header>
          <Typography variant='h6' style={{textTransform:'uppercase'}}>Editar Entrega</Typography>
...
export default SidebarEditEntrega
